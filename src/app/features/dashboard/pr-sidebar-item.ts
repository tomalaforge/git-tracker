        ...
        <div class="min-w-0 flex-1">
          ...
          <div class="flex items-center gap-1.5 mt-1 flex-wrap">
            ...
            <div class="flex items-center gap-1.5 pt-0.5">
              ...
              <!-- Merge Conflicts Icon -->
              @if (prData().hasConflicts) {
                <div title="Merge conflicts" class="text-danger flex-shrink-0 animate-pulse-slow">
              ...
              @if (prData().discussionStatus !== 'NONE') {
                <div
                  [title]="
                    prData().discussionStatus === 'NEW_CONTENT'
              ...
              <!-- Loading spinner (overlay or alongside) -->
              @if (prData().isLoading) {
                <svg
                  class="w-3.5 h-3.5 animate-spin-slow text-text-muted flex-shrink-0"
                  fill="none"
                  viewBox="0 0 24 24"
                >
